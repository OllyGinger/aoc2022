// From: https://github.com/michael-long88/advent-of-code-2022/blob/main/src/bin/09.rs
...
pub fn run(data: &str) -> String {
    let part1 = part_one(data).unwrap();
    let part2 = part_two(data).unwrap();

    return format!("Part 1: {}, Part 2: {}", part1, part2);
}
